...
import { getUpload, postUpload, watch, postWatch, getMyVideo, postMyVideo, getWatchRecode, postWatchRecode } from "../controller/videoController.js";
...
videoRouter.route('/watch/:id').get(watch).post(postWatch);
